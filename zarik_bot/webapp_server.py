...
# По умолчанию ищем teo.db рядом с teo_bot/ (sibling директория zarik_bot)
_TEO_DB_DEFAULT     = str(Path(__file__).parent.parent / "teo_bot" / "teo.db")
TEO_DB_PATH         = os.environ.get("TEO_DB_PATH", _TEO_DB_DEFAULT)
