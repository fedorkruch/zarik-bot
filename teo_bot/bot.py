...
START_MESSAGE = (
    ...
    "Я работаю с тремя областями жизни: карьера и работа, здоровье и спорт, финансы и деньги. "
    "Помогу разобраться что важно именно тебе, разложить это на шаги и двигаться вперёд.\n\n"
